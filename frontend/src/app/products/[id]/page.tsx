      ...
      {loading ? (
        ...
        <div className="space-y-8">
          <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
            <div className="overflow-hidden rounded-2xl border border-black/10 bg-white/80 shadow-[0_4px_16px_rgba(16,35,30,0.05)] dark:border-white/10 dark:bg-white/5">
              <div className="flex aspect-square items-center justify-center bg-white p-6 dark:bg-white/5">
                <img
                  src={
                    product.image_url ||
          ...
          <div className="space-y-6 rounded-2xl border border-black/10 bg-white/80 p-6 shadow-[0_4px_16px_rgba(16,35,30,0.05)]">
            ...
            {ratingSource === "external" ? (
              <p className="text-xs text-slate-400">
                Ratings imported from the external vendor source.
              </p>
            ) : null}
