...
import { savedSearchRouter } from "./modules/savedSearch/savedSearch.route";
import { scrapingRouter } from "./modules/scraping/scraping.route";
import { adminRouter } from "./modules/admin/admin.routes";
import { analyticsRouter } from "./modules/analytics/analytics.route";
import { notificationRouter } from "./modules/notification/notification.route";
import { priceAlertRouter } from "./modules/priceAlert/priceAlert.route";
